...
/*   Updated: 2023/06/25 18:26:08 by taehkwon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin_mandatory(char const *s1, char const *s2)
{
	...
	if (!s1 && !s2)
		...
		return (ft_strdup_mandatory(s2));
	else if (!s2)
		return (ft_strdup_mandatory(s1));
	s1_len = ft_strlen_mandatory(s1);
	s2_len = ft_strlen_mandatory(s2);
...
char	*ft_substr_mandatory(char const *s, unsigned int start, size_t len)
{
	...
	if (!s)
		return (0);
	s_len = ft_strlen_mandatory(s);
	if (start >= s_len)
		return (ft_strdup_mandatory(""));
